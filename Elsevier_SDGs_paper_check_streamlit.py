...
if SDGs_choice == '17':
    ...
    if cond1_final or cond2_final or cond3_final or cond6_final:
        st.write('查核結果: 恭喜您 ! 你的論文被收錄在 Elsevier SDGs 17: Partnerships for the Goals')
    else:
        st.write('查核結果: 很遺憾 ! 你的論文沒有被收錄在 Elsevier SDGs 17: Partnerships for the Goals')

    with st.expander("SDGs 17 重要關鍵字, 添加這些關鍵字於 title, abstract, keywords 將有助於論文被收錄於 SDGs 17"):
